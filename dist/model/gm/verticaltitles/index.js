...
class verticaltitles {
    constructor(data, coversPath) {
        // 标题1
        this.titleOne = '';
        // 标题2
        this.titleTwo = '';
    ...
    splitDeal(callback) {
        ...
        if (len <= 12) {
            ...
            let deal = new deal_1.default(this.titleOne, this.titleTwo, this.id, this.coversPath);
            deal.single(() => {
...
exports.default = verticaltitles;
